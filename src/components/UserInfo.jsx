    ...
    return (
        <ul className="userinfo__table--body">
            <li className='userinfo__table--header'>
                ...
                <button className='userinfo__table--header__button'
                    onClick={handleClickEdit}>Edit</button>
            </li>
            <li className='userinfo__table--photo'>
                <span id='left'>PHOTO</span>
                <span>
                    {user.picture ? <img className="userinfo__tabel--photo__image" src={user.picture} alt="userPhoto" /> :
            ...
            <li className='userinfo__table--bio'>
                ...
                {user.description ? <span>{user.description}</span> : <span>Write Something here ...</span>}
            </li>
