...
const FormEdit = ({user}) => {
    ...
    const {formUpdate,handleSubmitUpdate, handleFormUpdate,error,show} = useAuth()
    return (
        <>
            <Form method='POST' encType="multipart/form-data" className='userEditInfoContainer--form' onSubmit={(e) => {handleSubmitUpdate(e,photo)}} autoComplete="off">
